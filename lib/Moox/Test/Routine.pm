...
Moox::Test::Routine - A simple test framework for Moo which provides a slice of the functionality of Test::Routine without the complexity of Moose
...
This module provides enough of the Test::Routine look and feel to make nice tests when using Moo
